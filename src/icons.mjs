import { createElement, ArrowLeft, Plus, X, Settings, Pencil, Trash2, LogOut, Copy, Eye } from 'lucide';

const icons = { back: ArrowLeft, plus: Plus, close: X, settings: Settings, edit: Pencil, trash: Trash2, logout: LogOut, copy: Copy, preview: Eye };
